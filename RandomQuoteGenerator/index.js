let genQuoteBtn = document.getElementById('genQuoteBtn');
let addGenQuote = document.getElementById('addGenQuote');
let addGenAuthor = document.getElementById('addGenAuthor');
...
genQuoteBtn.addEventListener('click', () => {
    let randomQuote = Math.floor(Math.random() * randomQuotes.length);
    addGenQuote.innerHTML = randomQuotes[randomQuote].quote;
    addGenAuthor.innerHTML = randomQuotes[randomQuote].author;
});